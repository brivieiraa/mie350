...
INSERT INTO rooms (roomCode, building, roomType, capacity) VALUES ('GR200', 'Goldring Centre for High Performance Sport', 'Gymnasium', 2000);
...
INSERT INTO rooms (roomCode, building, roomType, capacity) VALUES ('SS1086', 'Sidney Smith Hall', 'Tutorial', 50);
...
INSERT INTO events (eventCode, eventName, studentGroup, room, dateTime, duration, description, eventType, eventCapacity) VALUES (2, 'Origami Workshop', 3007, 'SS1086', '2023/12/01 16:00:01', 2, 'Drop in and fold origami!', 'Arts', 60);
INSERT INTO events (eventCode, eventName, studentGroup, room, dateTime, duration, description, eventType, eventCapacity) VALUES (3, 'Barbershop', 3006, 'HH020', '2023/12/04 12:00:01', 4, 'Black Futures Presents: Barbershop – Bi-weekly hair services right on campus. Whether you need to refresh your fade, or crisp up that line. Barbershop has got you covered.', 'Arts', 15);
INSERT INTO events (eventCode, eventName, studentGroup, room, dateTime, duration, description, eventType, eventCapacity) VALUES (4, 'Varsity Games', 3008, 'GR200', '2023/12/05 10:10:01', 2, 'Come watch the best of the best of U of T athletics compete against other universities from across Canada', 'Athletic', 2000);
INSERT INTO events (eventCode, eventName, studentGroup, room, dateTime, duration, description, eventType, eventCapacity) VALUES (5, 'Interfaith Movies & Connections', 3009, 'MF100', '2023/12/07 15:30:01', 2, 'Interfaith movie nights are a fun opportunity to relax and connect. Every month we will show films highlighting a diverse array of faith traditions and experiences.', 'Religous', 100);
INSERT INTO events (eventCode, eventName, studentGroup, room, dateTime, duration, description, eventType, eventCapacity) VALUES (6, 'Interfaith Meals Pongal Celebration', 3009, 'MF100', '2024/01/15 12:00:01', 2, 'As part of the Interfaith Meals program, the Multi-Faith Centre and Centre for International Experience will be hosting a lunch in honour of Pongal on Monday 15th, from 12:00-2:00pm.', 'Religous', 75);
INSERT INTO events (eventCode, eventName, studentGroup, room, dateTime, duration, description, eventType, eventCapacity) VALUES (7, 'The Art of Belly Dance', 3006, 'HH030', '2023/11/23 17:00:01', 2, 'Learn technique through the culture of the anatomy, the mental and physical benefits for the mind and body, and the conception of one of the first forms of dance known to mankind amid the first civilizations as we know it.', 'Athletic', 20);
